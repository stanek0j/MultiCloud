...
/**
 * cz.zcu.kiv.multicloud.core.oauth2/WebPage.java
 *
 * Abstract class defining basic structure of a web page returned by the {@link cz.zcu.kiv.multicloud.core.oauth2.RedirectServer} after the redirect from an external authorization site.
 *
