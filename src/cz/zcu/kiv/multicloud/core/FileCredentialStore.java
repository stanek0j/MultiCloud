 ...
 *
 * Implementation of the {@link cz.zcu.kiv.multicloud.core.CredentialStore} using simple {java.io.File} as a base for storing the tokens.
 *
...
public class FileCredentialStore implements CredentialStore {
	...
	/**
	 * Ctor with supplied {@link java.io.File} and {@link cz.zcu.kiv.multicloud.core.FileSerialization} of the credential store.
	 * @param file Credential store file.
	...
	/**
	 * Ctor with supplied path to the credential store file and {@link cz.zcu.kiv.multicloud.core.FileSerialization} of the credential store.
	 * @param file Path to the file.
	 * @param fileSerialization File serialization.
	 */
